...
#define TOX_ERR_FILE_SEND_SEEK				TOX_ERR_FILE_SEEK
#define TOX_ERR_FILE_SEND_SEEK_OK			TOX_ERR_FILE_SEEK_OK
#define TOX_ERR_FILE_SEND_SEEK_FRIEND_NOT_FOUND		TOX_ERR_FILE_SEEK_FRIEND_NOT_FOUND
#define TOX_ERR_FILE_SEND_SEEK_FRIEND_NOT_CONNECTED	TOX_ERR_FILE_SEEK_FRIEND_NOT_CONNECTED
#define TOX_ERR_FILE_SEND_SEEK_NOT_FOUND		TOX_ERR_FILE_SEEK_NOT_FOUND
#define TOX_ERR_FILE_SEND_SEEK_DENIED			TOX_ERR_FILE_SEEK_DENIED
#define TOX_ERR_FILE_SEND_SEEK_INVALID_POSITION		TOX_ERR_FILE_SEEK_INVALID_POSITION
#define TOX_ERR_FILE_SEND_SEEK_SENDQ			TOX_ERR_FILE_SEEK_SENDQ

#define TOX_ERR_FILE_SEND_CONTROL			TOX_ERR_FILE_CONTROL
#define TOX_ERR_FILE_SEND_CONTROL_OK			TOX_ERR_FILE_CONTROL_OK
#define TOX_ERR_FILE_SEND_CONTROL_FRIEND_NOT_FOUND	TOX_ERR_FILE_CONTROL_FRIEND_NOT_FOUND
#define TOX_ERR_FILE_SEND_CONTROL_FRIEND_NOT_CONNECTED	TOX_ERR_FILE_CONTROL_FRIEND_NOT_CONNECTED
#define TOX_ERR_FILE_SEND_CONTROL_NOT_FOUND		TOX_ERR_FILE_CONTROL_NOT_FOUND
#define TOX_ERR_FILE_SEND_CONTROL_NOT_PAUSED		TOX_ERR_FILE_CONTROL_NOT_PAUSED
#define TOX_ERR_FILE_SEND_CONTROL_DENIED		TOX_ERR_FILE_CONTROL_DENIED
#define TOX_ERR_FILE_SEND_CONTROL_ALREADY_PAUSED	TOX_ERR_FILE_CONTROL_ALREADY_PAUSED
#define TOX_ERR_FILE_SEND_CONTROL_SENDQ			TOX_ERR_FILE_CONTROL_SENDQ
