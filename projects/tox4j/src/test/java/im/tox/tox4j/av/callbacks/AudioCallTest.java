...
//  @NotNull
//  @Override
//  protected ChatClient newAlice(String name) throws Exception {
...
//  @NotNull
//  @Override
//  protected ChatClient newBob(String name) throws Exception {
//    return new Bob(name);
//  }
//
...
//
//    public Bob(String name) throws Exception {
//      super(name);
...
//      assertEquals(FRIEND_NUMBER(), friendNumber);
//      debug("received call from " + friendName());
//      addTask(new Task() {
