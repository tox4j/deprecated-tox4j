...
object Ast {
  ...
  final case class MacroFun(init: FunCall, body: Stmt) extends Preproc
  ...
  final case class Switch(cond: Expr, body: Stmt) extends Stmt
  ...
  final case class Fun(returnType: Type, name: String, params: Seq[Decl], body: Stmt) extends Decl
